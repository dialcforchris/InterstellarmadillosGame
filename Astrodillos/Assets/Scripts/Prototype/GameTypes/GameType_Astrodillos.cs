...
//	public MissileManager missileManager;
	...
	public void Explosion(Vector3 explosionPos, GameObject hitObject = null, float explosionSize = 0.2f){
		...
		if (hitObject != null) {
			DestructibleObject destructObj = hitObject.GetComponent<DestructibleObject>();
			if(destructObj!=null){
